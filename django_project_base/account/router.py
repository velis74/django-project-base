...
from django_project_base.account.rest.account import (
    AdminAddUserViewSet, ChangePasswordViewSet, LogoutViewSet, RegisterViewSet, SocialAuthProvidersViewSet,
...
from django_project_base.account.rest.reset_password import (
    InvalidatePasswordAdminViewSet, ResetPasswordViewSet, SendResetPasswordLinkViewSet
)
