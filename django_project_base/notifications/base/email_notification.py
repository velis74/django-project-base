...
class EmailNotification(Notification):
    ...
    def __init__(self, level: Optional[NotificationLevel] = None, locale: Optional[str] = None,
                 delay: Optional[datetime] = None, recipients: List[settings.AUTH_USER_MODEL] = [], **kwargs) -> None:
        super().__init__(persist=True, level=level, locale=locale, delay=delay, recipients=recipients, **kwargs)
