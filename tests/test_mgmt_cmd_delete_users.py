...
class MgmtCmdDeleteUsersTest(TestCase):
    ...
    def test_call_command(self):
        ...
        delete_in_future = profile.create(first_name="John", last_name="Pitt", username="JohnPitt",
                                          delete_at=datetime.datetime.now() + timedelta(days=1))
        delete_in_past = profile.create(first_name="Johanna", last_name="Pitt", username="JohannaPitt",
                                        delete_at=datetime.datetime.now() - timedelta(minutes=1))
